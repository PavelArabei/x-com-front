...
import { computersCategoryNames } from '@assets/mock/sub-categories/computers-category';
import { smartphonesCategoryNames } from '@assets/mock/sub-categories/smartphones-category';
